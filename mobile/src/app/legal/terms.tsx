  ...
  return (
    <View style={[styles.container, { backgroundColor: C.bg }]}>
      ...
      <View style={[styles.header, { backgroundColor: C.headerBg, borderBottomColor: C.border }]}>
        ...
        <Text style={[styles.headerTitle, { color: C.headerTitle }]}>Terms of Service</Text>
        <View style={{ width: 40 }} />
      </View>
      ...
      >
        ...
        <Text style={[styles.pageTitle, { color: C.pageTitle }]}>Terms of Service</Text>
        <Text style={[styles.effectiveDate, { color: C.meta }]}>Effective: August 2026 · MathMentor AI</Text>

        <Section title="1. Acceptance of Terms" colors={{ title: C.secTitle, body: C.secBody }}>
        ...
        <Section title="2. Description of Service" colors={{ title: C.secTitle, body: C.secBody }}>
        ...
        <Section title="3. User Accounts" colors={{ title: C.secTitle, body: C.secBody }}>
        ...
        <Section title="4. Acceptable Use" colors={{ title: C.secTitle, body: C.secBody }}>
        ...
        <Section title="5. Intellectual Property" colors={{ title: C.secTitle, body: C.secBody }}>
        ...
        <Section title="6. AI-Generated Content" colors={{ title: C.secTitle, body: C.secBody }}>
        ...
        <Section title="7. Privacy" colors={{ title: C.secTitle, body: C.secBody }}>
        ...
        <Section title="8. Disclaimers" colors={{ title: C.secTitle, body: C.secBody }}>
        ...
        <Section title="9. Limitation of Liability" colors={{ title: C.secTitle, body: C.secBody }}>
        ...
        <Section title="10. Changes to Terms" colors={{ title: C.secTitle, body: C.secBody }}>
        ...
        <Section title="11. Contact" colors={{ title: C.secTitle, body: C.secBody }}>
