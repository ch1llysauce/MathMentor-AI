...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
  ...
  const dismissSessionRevoked = () => {
    setSessionRevoked(false);
  };

  return (
    <AuthContext.Provider value={{ user, loading, sessionRevoked, login, loginWithGoogle, loginWithToken, register, logout, updateUser, validate2FA, dismissSessionRevoked }}>
      {children}
