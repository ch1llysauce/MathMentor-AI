 ...
 * 9 buckets (3 topics x 3 difficulties), 1 question picked per bucket per test.
 */
...
const Trigonometry_Easy = [
    ...
    () => {
        ...
        return {
            ...
            explanation: `opp = ${hyp} × sin(${d.angle}°) ≈ ${d.opp} cm.`,
...
const Trigonometry_Medium = [
    ...
    () => {
        ...
        return {
            ...
            explanation: `tan(${d.angle}°) = ${cliff}/d  →  d = ${cliff}/${d.tan} ≈ ${d.dist} m.`,
...
const Trigonometry_Hard = [
    () => {
        ...
        const angData = [
            { C: 60,  c: parseFloat(Math.sqrt(a*a + b*b - 2*a*b*0.5).toFixed(1)) },
            { C: 90,  c: parseFloat(Math.sqrt(a*a + b*b).toFixed(1)) },
