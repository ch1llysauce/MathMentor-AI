              ...
              <>
                ...
                <div>
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 bg-white border border-[#c5c6cd] hover:border-[#4b41e1] text-[#091426] font-semibold py-3 px-4 rounded-xl transition-all shadow-xs disabled:opacity-60 disabled:cursor-not-allowed"
                  >
                    {googleLoading ? (
                      <>
                        <div className="w-4 h-4 border-2 border-[#4b41e1] border-t-transparent rounded-full animate-spin" />
